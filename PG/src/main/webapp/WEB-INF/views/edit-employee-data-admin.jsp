...
<div id="wrapper">
    ...
    <div id="textbox">
		<form action="/app/admin/editEmployee" method="post" class="form-horizontal">	
			<div class="form-group">
				<label class="col-sm-4 control-label">Потребителско име:</label>
		    	<div class="col-sm-4">
		    		<label class="col-sm-0 control-label"><c:out value="${employee.username}"/></label>
				</div>
			</div>
			<div class="form-group">
				<label for="firstName" class="col-sm-4 control-label">Име:</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" name="firstName" id="firstName" value="${employee.firstName}" maxlength="25" required>
				</div>
			</div>
			<div class="form-group">
				<label for="lastName" class="col-sm-4 control-label">Фамилия:</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" name="lastName" id="lastName" value="${employee.lastName}" maxlength="25" required>
				</div>
			</div>
			<div class="form-group">
				<label for="email" class="col-sm-4 control-label">Поща:</label>
				<div class="col-sm-4">
					<input type="email" class="form-control" name="email" id="email" value="${employee.email}" maxlength="35" required>
				</div>
			</div>
			<div class="form-group">
				<label for="parkingNumber" class="col-sm-4 control-label">Номер на паркинг:</label>
				<div class="col-sm-4">
					<input type="number" class="form-control" name="parkingNumber" id="parkingNumber" min="0" max="1000" value="${employee.parkingNumber}" required>
				</div>
			</div>
			<div class="form-group">
		...
		<form action="/app/admin/deleteEmployee" method="post" class="form-horizontal" onsubmit="return confirm('Наистина ли искате да изтриете този запис от системата?');">
			<div class="form-group">
		    	<div class="col-sm-offset-4 col-sm-2">
		    		<input type="hidden" name="username" value="${employee.username}">
