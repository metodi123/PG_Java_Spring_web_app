...
<div id="wrapper">
    ...
    <div id="textbox">
		<form action="/app/employee/editPost" method="post">
			<div class="row">
	    ...
	    <div class="row">
			<div class="col-sm-offset-5 col-sm-2">
				<form action="/app/employee/deletePost" method="post" class="form-horizontal" onsubmit="return confirm('Наистина ли искате да изтриете този запис от системата?');">	
					<br>
